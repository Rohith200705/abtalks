...
import { progressApi, challengesApi, achievementsApi } from "@/lib/api";
import { useAuth } from "@/contexts/AuthContext";
import type { Progress, Challenge, Achievement } from "@/types";
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      setError(null);
      try {
        const [progressRes, challengeRes, achievementsRes] = await Promise.allSettled([
          progressApi.get(),
